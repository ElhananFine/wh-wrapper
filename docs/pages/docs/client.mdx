...
Sure, here's the documentation for the `createTemplate` method, formatted for your documentation site:
...
- `header` (object, optional): The header of the template.
  ...
  - `text` (string, required for `type: "TEXT"`): The text content for the header (up to 60 characters, supports 1 variable).
...
- `body` (string or object, required): The body of the template.
  - If a string, the text content for the body (up to 1024 characters, supports multiple variables).
...
- `footer` (string, optional): The footer text for the template (up to 60 characters).
...
- `UrlButton`: A button that opens a specified URL when clicked.
  ...
  - `title` (string, required): The button text (up to 25 characters, supports 1 variable).
  - `url` (string, required): The URL to be opened (up to 2000 characters, supports 1 variable).
