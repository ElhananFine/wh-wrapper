...
exports.SendTemplateSchema = exports.SendContacSchema = exports.SendContacOptionSchema = exports.phoneSchema = exports.nameSchema = exports.CreateTempleteSchema = exports.UpdateBusinessProfileSchema = exports.sendMessageSchema = exports.sendMediaSchema = exports.sendMediaInteractiveSchema = exports.sendMessageOptionsSchema = exports.Language = void 0;
const z = __importStar(require("zod"));
const client_interface_1 = require("../interfaces/client-interface");
exports.Language = {
    AFRIKAANS: "af",
    ALBANIAN: "sq",
    ARABIC: "ar",
...
exports.sendMessageOptionsSchema = z.object({
    ...
    messageID: z
        .string({ invalid_type_error: "The messageId must be a string" })
        .optional(),
    header: z
        .string()
        .max(60, { message: "Maximum header 60 characters" })
        .optional(),
    footer: z
        .string()
        .max(60, { message: "Maximum footer 256 characters" })
        .optional(),
    buttons: z
        .union([
        replyButtons,
...
exports.sendMediaInteractiveSchema = z
    ...
    .optional();
exports.sendMediaSchema = z.object({
    messageID: z.string().optional(),
});
...
exports.UpdateBusinessProfileSchema = z.object({
    ...
    industry: z.nativeEnum(client_interface_1.WhatsAppProfileVertical),
    profilePictureHandle: z.string().optional(),
    websites: z
        .array(z.string().url().max(256))
        .max(2, { message: "Maximum of two sites per profile" })
        .optional(),
});
...
exports.phoneSchema = z.union([
    z.string(),
    phonesObject,
    z.array(phonesObject),
]);
