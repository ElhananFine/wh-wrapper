        ...
        try {
            ...
            if (saveToFile) {
                try {
                    ...
                    const filePath = path_1.default.join(filesDirectoryPath, `${(fileName === null || fileName === void 0 ? void 0 : fileName.replace(/[\\/:\*?"<>|]/g, "")) || linkRequest.url.split("hash=")[1]}.${linkRequest.mime_type.split("/")[1]}`);
