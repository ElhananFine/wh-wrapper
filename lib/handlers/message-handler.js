...
class Message extends base_handler_1.BaseHandler {
    constructor(client, value) {
        ...
        this.forwarded =
            ((_a = value.messages[0].context) === null || _a === void 0 ? void 0 : _a.forwarded) ||
                ((_b = value.messages[0].context) === null || _b === void 0 ? void 0 : _b.frequently_forwarded) ||
                false;
        if (this.forwarded)
            this.forwardedManyTimes =
                ((_c = value.messages[0].context) === null || _c === void 0 ? void 0 : _c.frequently_forwarded) || false;
        this.isReply = !!value.messages[0].context;
        this.hasMedia = ["image", "video", "sticker", "document", "audio"].includes(this.type);
        switch (this.type) {
            case "text":
                this.text = (_d = value.messages[0].text) === null || _d === void 0 ? void 0 : _d.body;
                break;
            case "image":
