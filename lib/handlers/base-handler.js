...
class BaseHandler {
    constructor(client, value) {
        ...
        this.client = client;
        const whID = (((_b = (_a = value.contacts) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.wa_id) ||
            ((_d = (_c = value.statuses) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.recipient_id));
        this.sender = whID;
