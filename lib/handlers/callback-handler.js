...
class Callback extends base_handler_1.BaseHandler {
    constructor(client, value) {
        ...
        if (value.messages[0].context)
            this.replyToMessage = {
                ...(((_a = value.messages[0].context) === null || _a === void 0 ? void 0 : _a.id) && {
                    messageID: (_b = value.messages[0].context) === null || _b === void 0 ? void 0 : _b.id,
                }),
                ...(((_c = value.messages[0].context) === null || _c === void 0 ? void 0 : _c.from) && {
                    messfromUserID: (_d = value.messages[0].context) === null || _d === void 0 ? void 0 : _d.from,
                }),
            };
        this.data = {
            title: value.messages[0].interactive[value.messages[0].interactive.type]
                .title,
