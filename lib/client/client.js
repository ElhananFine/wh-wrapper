...
class Client extends events_1.EventEmitter {
    constructor(phoneID, token, verifyToken, options = {}) {
        ...
        this.url = `${
            ((_a = this.options) === null || _a === void 0 ? void 0 : _a.baseURL) || "https://graph.facebook.com"
        }/v${
            ((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.apiVersion) === null || _c === void 0
                ? void 0
                : _c.toString()) || "19.0"
        }`;
    ...
    async initialize() {
        ...
        this.options.server.get(
            ((_a = this === null || this === void 0 ? void 0 : this.options) === null || _a === void 0
                ? void 0
                : _a.webHookEndpoint) || "/",
            (req, res) => {
        ...
        this.options.server.post(
            ((_b = this.options) === null || _b === void 0 ? void 0 : _b.webHookEndpoint) || "/",
            (req, res) => {
                try {
    ...
    async setCallBackUrl(callbackUrl, appID, appSecret) {
    ...
    async createTemplate(template) {
        ...
        if (template.header) {
            ...
            if (
                ...
                if (variables)
                    header.example = {
                        header_text:
                            variables === null || variables === void 0 ? void 0 : variables.map((v) => v.slice(2, -2)),
                    };
            }
        ...
        if (template.footer)
            (_c = data.components) === null || _c === void 0
                ? void 0
                : _c.push({
                      type: "FOOTER",
        ...
        if (template.buttons) {
            ...
            if (
                template.buttons.filter((b) => (b === null || b === void 0 ? void 0 : b.type) === "PhoneNumberButton")
                    .length > 1
            )
    ...
    async sendInteractiveMessage(to, text, data, header) {
        ...
        buttonArray === null || buttonArray === void 0
            ? void 0
        ...
        if (!(options === null || options === void 0 ? void 0 : options.buttons)) {
            return (
                await this._sendMessage({
                    ...
                    [type.toLowerCase()]: {
                        ...((options === null || options === void 0 ? void 0 : options.capiton) && {
                            caption: options.capiton,
                        }),
                        ...
                        ...(type === "DOCUMENT" &&
                            (options === null || options === void 0 ? void 0 : options.filename) && {
    ...
    async sendMessage(to, text, options) {
        ...
        if (
            !(options === null || options === void 0 ? void 0 : options.buttons) &&
            !(options === null || options === void 0 ? void 0 : options.header) &&
            !(options === null || options === void 0 ? void 0 : options.footer)
        ) {
            return (
                await this._sendMessage({
                    ...data,
                ...
                contacts: [
                    {
                        ...
                        ...((options === null || options === void 0 ? void 0 : options.birthday) && {
    ...
    async uploadMedia(media) {
        ...
        if (media.startsWith("http")) {
            ...
            if (!fs_1.default.existsSync(media)) throw new Error("חובה לספק נתיב קובץ תקין");
